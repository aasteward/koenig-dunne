...
class WPV_Editor {
	...
	public function third_party_shortcodes( $available_shortcodes ) {
		...
		if ( is_plugin_active( 'vamtam-twitter/vamtam-twitter.php' ) )
			$available_shortcodes['wpv_twitter'] = 'layouts';
	...
	public function admin_init() {
		...
		foreach ( $post_types as $type ) {
			add_meta_box( 'wpv_visual_editor', __( 'Visual Editor', 'lawyers-attorneys' ), array( &$this, 'editor' ), $type, 'advanced', 'low' );
		}
	...
	public function enqueues() {
		...
		wp_localize_script( 'wpv-editor', 'WPVED_LANG', array(
				'empty_notice' => __( 'Please drag  any element you want here.', 'lawyers-attorneys' ),
			) );
	}
							...
							<?php if ( isset( $wpv_sc[$slug]['desc'] ) ): ?>
								<div class="description">
									...
									<div>
										...
										<footer><a href="<?php echo esc_attr(admin_url( 'admin.php?page=wpv_help' )) ?>" title="<?php _e( 'Read more in our documentation', 'lawyers-attorneys' ) ?>"><?php _e( 'Read more in our documentation', 'lawyers-attorneys' ) ?></a></footer>
									</div>
								</div>
							<?php endif ?>
						</li>
