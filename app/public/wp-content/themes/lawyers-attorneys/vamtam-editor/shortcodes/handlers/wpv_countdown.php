	...
	public function shortcode( $atts, $content = null, $code ) {
		...
		<div class="wpv-countdown regular" data-until="<?php echo esc_attr( strtotime( $datetime ) ) ?>" data-done="<?php echo esc_attr( $done ) ?>" data-respond>
			<span class="wpvc-days wpvc-block">
				<div class="value"></div>
				<div class="value-label"><?php _e('Days', 'lawyers-attorneys') ?></div>
			</span>
			<span class="wpvc-sep">:</span>
			<span class="wpvc-hours wpvc-block">
				<div class="value"></div>
				<div class="value-label"><?php _e('Hours', 'lawyers-attorneys') ?></div>
			</span>
			...
			<span class="wpvc-minutes wpvc-block">
				<div class="value"></div>
				<div class="value-label"><?php _e('Minutes', 'lawyers-attorneys') ?></div>
			</span>
			<span class="wpvc-sep">:</span>
			<span class="wpvc-seconds wpvc-block">
				<div class="value"></div>
				<div class="value-label"><?php _e('Seconds', 'lawyers-attorneys') ?></div>
			</span>
		</div>
<?php
		return ob_get_clean();
