<?php
return array(
	'name' => __('Revolution Slider', 'lawyers-attorneys') ,
	...
	If you need to activate the slider in the Header, then you will need the option - "Page Slider" found below the editor. ' , 'lawyers-attorneys'),
	'icon' => array(
	...
	'options' => array(
		array(
			'name' => __('Slider', 'lawyers-attorneys') ,
			'id' => 'alias',
			'default' => '',
