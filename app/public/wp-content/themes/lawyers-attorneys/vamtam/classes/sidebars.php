...
class WpvSidebars {
	...
	public function __construct() {
		$this->sidebars = array(
			'page' => __( 'Shared Page Widget Area', 'lawyers-attorneys' ),
			'blog' => __( 'Blog Widget Area', 'lawyers-attorneys' ),
			'portfolio' => __( 'Portfolio Widget Area', 'lawyers-attorneys' ),
		);

		if ( wpv_has_woocommerce() )
			$this->sidebars['wpv-woocommerce'] = __( 'WooCommerce Widget Area', 'lawyers-attorneys' );
