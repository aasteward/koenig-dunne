	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'wpv_admin', 'WPV_ADMIN', array(
				...
				'addNewIcon' => __( 'Add New Icon', 'lawyers-attorneys' ),
				'iconName'   => __( 'Icon', 'lawyers-attorneys' ),
				'iconText'   => __( 'Text', 'lawyers-attorneys' ),
				'iconLink'   => __( 'Link', 'lawyers-attorneys' ),
				'iconChange' => __( 'Change', 'lawyers-attorneys' ),
