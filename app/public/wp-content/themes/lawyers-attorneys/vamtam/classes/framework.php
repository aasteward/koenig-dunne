...
class WpvFramework {
	...
	public function theme_supports() {
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
					'menu-header' => __( 'Menu Header', 'lawyers-attorneys' ),
					'menu-top' => __( 'Menu Top', 'lawyers-attorneys' ),
				)
			);
		}

		add_image_size( 'posts-widget-thumb', 60, 60, true );
		add_image_size( 'posts-widget-thumb-small', 60, 60, true );
	...
	private function load_languages() {
		load_theme_textdomain( 'lawyers-attorneys', THEME_DIR . 'languages' );
	}
	...
	public function load_types() {
		...
		register_post_type(
			'portfolio', array(
				'labels' => array(
					'name' => _x( 'Portfolios', 'post type general name', 'lawyers-attorneys' ),
					'singular_name' => _x( 'Portfolio', 'post type singular name', 'lawyers-attorneys' ),
					'add_new' => _x( 'Add New', 'portfolio', 'lawyers-attorneys' ),
					'add_new_item' => __( 'Add New Portfolio', 'lawyers-attorneys' ),
					'edit_item' => __( 'Edit Portfolio', 'lawyers-attorneys' ),
					'new_item' => __( 'New Portfolio', 'lawyers-attorneys' ),
					'view_item' => __( 'View Portfolio', 'lawyers-attorneys' ),
					'search_items' => __( 'Search Portfolios', 'lawyers-attorneys' ),
					'not_found' => __( 'No portfolios found', 'lawyers-attorneys' ),
					'not_found_in_trash' => __( 'No portfolios found in Trash', 'lawyers-attorneys' ),
					'parent_item_colon' => '',
				),
				'singular_label' => __( 'portfolio', 'lawyers-attorneys' ),
				'public' => true,
		...
		register_taxonomy(
				...
				'hierarchical' => true,
				'labels' => array(
					'name' => _x( 'Portfolio Categories', 'taxonomy general name', 'lawyers-attorneys' ),
					'singular_name' => _x( 'Portfolio Category', 'taxonomy singular name', 'lawyers-attorneys' ),
					'search_items' => __( 'Search Portfolio Categories', 'lawyers-attorneys' ),
					'popular_items' => __( 'Popular Portfolio Categories', 'lawyers-attorneys' ),
					'all_items' => __( 'All Portfolio Categories', 'lawyers-attorneys' ),
					'parent_item' => null,
					'parent_item_colon' => null,
					'edit_item' => __( 'Edit Portfolio Category', 'lawyers-attorneys' ),
					'update_item' => __( 'Update Portfolio Category', 'lawyers-attorneys' ),
					'add_new_item' => __( 'Add New Portfolio Category', 'lawyers-attorneys' ),
					'new_item_name' => __( 'New Portfolio Category Name', 'lawyers-attorneys' ),
					'separate_items_with_commas' => __( 'Separate Portfolio category with commas', 'lawyers-attorneys' ),
					'add_or_remove_items' => __( 'Add or remove portfolio category', 'lawyers-attorneys' ),
					'choose_from_most_used' => __( 'Choose from the most used portfolio category', 'lawyers-attorneys' )
				),
				'show_ui' => true,
				'query_var' => true,
				'rewrite' => false,
		...
		register_post_type(
			'testimonials', array(
				'labels' => array(
					'name' => _x( 'Testimonials', 'post type general name', 'lawyers-attorneys' ),
					'singular_name' => _x( 'Testimonial', 'post type singular name', 'lawyers-attorneys' ),
					'add_new' => _x( 'Add New', 'testimonials', 'lawyers-attorneys' ),
					'add_new_item' => __( 'Add New Testimonial', 'lawyers-attorneys' ),
					'edit_item' => __( 'Edit Testimonial', 'lawyers-attorneys' ),
					'new_item' => __( 'New Testimonial', 'lawyers-attorneys' ),
					'view_item' => __( 'View Testimonial', 'lawyers-attorneys' ),
					'search_items' => __( 'Search Testimonials', 'lawyers-attorneys' ),
					'not_found' => __( 'No testimonials found', 'lawyers-attorneys' ),
					'not_found_in_trash' => __( 'No testimonials found in Trash', 'lawyers-attorneys' ),
					'parent_item_colon' => '',
				),
				'singular_label' => __( 'testimonial', 'lawyers-attorneys' ),
				'public' => true,
		...
		register_taxonomy(
			'testimonials_category','testimonials',array(
				'hierarchical' => true,
				'labels' => array(
					'name' => _x( 'Testimonials Category', 'taxonomy general name', 'lawyers-attorneys' ),
					'singular_name' => _x( 'Testimonial Category', 'taxonomy singular name', 'lawyers-attorneys' ),
					'search_items' => __( 'Search Categories', 'lawyers-attorneys' ),
					'popular_items' => __( 'Popular Categories', 'lawyers-attorneys' ),
					'all_items' => __( 'All Categories', 'lawyers-attorneys' ),
					'parent_item' => null,
					'parent_item_colon' => null,
					'edit_item' => __( 'Edit Testimonials Category', 'lawyers-attorneys' ),
					'update_item' => __( 'Update Testimonials Category', 'lawyers-attorneys' ),
					'add_new_item' => __( 'Add New Testimonials Category', 'lawyers-attorneys' ),
					'new_item_name' => __( 'New Testimonials Category Name', 'lawyers-attorneys' ),
					'separate_items_with_commas' => __( 'Separate Testimonials category with commas', 'lawyers-attorneys' ),
					'add_or_remove_items' => __( 'Add or remove testimonials category', 'lawyers-attorneys' ),
					'choose_from_most_used' => __( 'Choose from the most used testimonials category', 'lawyers-attorneys' )
				),
				'show_ui' => true,
				'query_var' => false,
				'rewrite' => false,
	...
	public function setup_adminbar() {
		...
		$wp_admin_bar->add_menu(
			array(
				'parent' => false,
				'id' => 'wpv-settings',
				'title' => __( 'Vamtam', 'lawyers-attorneys' ),
				'href' => admin_url( 'admin.php?page=wpv_general' ),
				'meta' => false,
			)
		);

		$adv_name = __( 'Theme options', 'lawyers-attorneys' );

		$pages = array(
			'general' => __( 'General Settings', 'lawyers-attorneys' ),
			'layout' => __( 'Layout', 'lawyers-attorneys' ),
			'styles' => __( 'Styles', 'lawyers-attorneys' ),
			'import' => __( 'Quick Import', 'lawyers-attorneys' ),
			'help' => __( 'Help', 'lawyers-attorneys' ),
		);
