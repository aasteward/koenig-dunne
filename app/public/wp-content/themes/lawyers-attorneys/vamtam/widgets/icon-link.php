...
class wpv_icon_link extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => __('Displays a list of links preceded by an icon', 'lawyers-attorneys')
		);
		parent::__construct('icon-link', __('Vamtam - Links with icons', 'lawyers-attorneys') , $widget_ops);
	}
