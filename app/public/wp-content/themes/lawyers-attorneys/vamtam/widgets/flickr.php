...
class WPV_Flickr_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => __( 'Displays photos from Flickr', 'lawyers-attorneys' )
		);
		parent::__construct('wpv_flickr', __('Vamtam - Flickr', 'lawyers-attorneys'), $widget_ops);
	}

	public function widget( $args, $instance ) {
		extract($args);
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Photos on flickr', 'lawyers-attorneys') : $instance['title'], $instance, $this->id_base);
