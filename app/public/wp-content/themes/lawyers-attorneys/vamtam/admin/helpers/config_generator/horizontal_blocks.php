<?php
	...
	$widths = array(
		'full' => __('Full', 'lawyers-attorneys'),
		'cell-1-2' => '1/2',
		'cell-1-3' => '1/3',
		'cell-1-4' => '1/4',
		'cell-1-5' => '1/5',
						...
						<div class="options">
							...
							<div>
								<label <?php if($width == 'full'):?>style="display:none"<?php endif?>>
									<input type="checkbox" name="<?php echo "$id_prefix-$i-last"?>" id="<?php echo "$id_prefix-$i-last"?>" value="true" class="<?php wpv_static($value)?>" <?php checked($is_last, true) ?> />&nbsp;<?php _e('last?', 'lawyers-attorneys') ?>
								</label>
								<label>
									<input type="checkbox" name="<?php echo "$id_prefix-$i-empty"?>" id="<?php echo "$id_prefix-$i-empty"?>" value="true" class="<?php wpv_static($value)?>" <?php checked($is_empty, true) ?> />&nbsp;<?php _e('empty?', 'lawyers-attorneys') ?>
								</label>
							</div>
						</div>
					</div>
