<div class="wpv-config-row clearfix">
	...
	<div class="rcontent">
		<select id="import-config-available" class="static">
			<option value=""><?php _e('Available skins', 'lawyers-attorneys')?></option>
		</select>
		<input type="button" id="import-config" class="button static" value="<?php echo $name ?>" />
		<input type="button" id="delete-config" class="button static" value="<?php _e('Delete', 'lawyers-attorneys') ?>" />
