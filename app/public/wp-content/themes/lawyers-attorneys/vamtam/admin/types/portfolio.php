...
function edit_portfolio_columns($portfolio_columns) {
	$columns = array(
		...
		"title" => _x('Title', 'column name', 'lawyers-attorneys' ),
		"portfolio_category" => __('Categories', 'lawyers-attorneys' ),
		"author" => __('Author', 'lawyers-attorneys' ),
		"date" => __('Date', 'lawyers-attorneys' ),
		"thumbnail" => __('Thumbnail', 'lawyers-attorneys' )
	);
