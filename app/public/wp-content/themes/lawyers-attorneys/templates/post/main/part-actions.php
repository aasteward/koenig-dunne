			...
			<div class="love-count-outer">
				<?php
					echo wpv_li_love_link(
						'<span class="icon">' . wpv_get_icon( 'heart' ) . '</span><span class="visuallyhidden">'.__( 'Love it', 'lawyers-attorneys' ).'</span>',
						'<span class="icon">' . wpv_get_icon( 'heart' ) . '</span><span class="visuallyhidden">'.__( 'You have loved this.', 'lawyers-attorneys' ).'</span>'
					);
				?>
			</div>
		<?php endif ?>
