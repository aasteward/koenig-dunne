	...
	<div class="classic-event-wrapper">
		<div class="row">
			<div class="grid-1-3">
				...
				<?php endif ?>
				<h3 class="event-title"><a href="<?php tribe_event_link( $event ) ?>" title="<?php esc_attr_e( 'Read More', 'lawyers-attorneys' ) ?>"><?php echo $event->post_title // xss ok ?></a></h3>
			</div>
			<div class="grid-2-3">
