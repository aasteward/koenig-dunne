...
<p>
	<label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Address:', 'lawyers-attorneys'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('address'); ?>" name="<?php echo $this->get_field_name('address'); ?>" type="text" value="<?php echo $address; ?>" />
	<small><?php _e('Choose either an address or latitute and logtitude', 'lawyers-attorneys')?></small>
</p>
		
<p>
	<label for="<?php echo $this->get_field_id('latitude'); ?>"><?php _e('Latitude:', 'lawyers-attorneys'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('longitude'); ?>"><?php _e('Longitude:', 'lawyers-attorneys'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('zoom'); ?>"><?php _e('Zoom level:', 'lawyers-attorneys'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('html'); ?>"><?php _e('Content for the marker:', 'lawyers-attorneys'); ?></label>
...
<p>
	...
	<label for="<?php echo $this->get_field_id('popup'); ?>"><?php _e('Auto popup the info?', 'lawyers-attorneys'); ?></label>
</p>
		
<p>
	<label for="<?php echo $this->get_field_id('height'); ?>"><?php _e('Height:', 'lawyers-attorneys'); ?></label>
