...
<p>
	<label><?php _e('Show Avatar:', 'lawyers-attorneys'); ?></label>
	<?php
...
<p>
	<label><?php _e('Show Post Count:', 'lawyers-attorneys'); ?></label>
	<?php
...
<p>
	<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('How many authors to display?', 'lawyers-attorneys'); ?></label>
		...
		<div class="hidden_el" <?php if($i>$count):?>style="display:none"<?php endif;?>>
			<p>
				<label for="<?php echo $this->get_field_id($author_id); ?>">
					<?php _e('Author:', 'lawyers-attorneys')?>
				</label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( $author_desc ); ?>">
					<?php _e('Author Description (optional):', 'lawyers-attorneys')?>
				</label>
