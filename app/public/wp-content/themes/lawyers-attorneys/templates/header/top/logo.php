...
<div class="logo-wrapper">
	<a href="#" id="mp-menu-trigger" class="icon-b" data-icon="<?php wpv_icon('menu1') ?>"><?php _e('Open/Close Menu', 'lawyers-attorneys') ?></a>
	<?php
	...
	<div class="mobile-logo-additions">
		<?php if ( wpv_has_woocommerce() ): ?>
			...
			<a class="vamtam-cart-dropdown-link icon theme" href="<?php echo esc_attr( $woocommerce->cart->get_cart_url() ) ?>">
