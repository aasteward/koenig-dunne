...
array(
	'name' => __('Body Layout', 'lawyers-attorneys'),
...
Note: You can override some of the options on a page by page basis: enable/disable body sidebars and body top widget areas.', 'lawyers-attorneys'),
	'type' => 'info',
),

array(
	'name' => __('Enable Breadcrumbs', 'lawyers-attorneys'),
	'desc' => __('Breadcrumbs is yet another navigation menu  just above the page title.', 'lawyers-attorneys'),
...
array(
	'name' => __('Enable Body Top Widget Areas', 'lawyers-attorneys'),
	'desc' => __('This option only enables the widget areas. You can choose the layout using the two options bellow. In appearance - widgets, you can populate the area with widgets. You can override this option on a page-by-page basis.', 'lawyers-attorneys'),
	'id' => 'has-header-sidebars',
	'type' => 'toggle',
),

array(
	'name' => __('Body Top Widget Area Pre-defined Layouts', 'lawyers-attorneys'),
	'desc' => __('The widget areas below are placed just below the page title. You can either choose one of the predefined layouts or configure your own in the "Advanced" section bellow.', 'lawyers-attorneys'),
	'type' => 'autofill',
	'class' => 'no-box',
	'option_sets' => array(
		array(
			'name' => __('1/3 | 1/3 | 1/3', 'lawyers-attorneys'),
		...
		array(
			'name' => __('1/4 | 1/4 | 1/4 | 1/4', 'lawyers-attorneys'),
		...
		array(
			'name' => __('1/5 | 1/5 | 1/5 | 1/5 | 1/5', 'lawyers-attorneys'),
...
array(
	'name' => __('Default Sidebar Layout', 'lawyers-attorneys'),
...
array(
	'name' => __('Sidebar Width', 'lawyers-attorneys'),
	'desc' => sprintf(__('The width is percent of the website width. If you have changed this option, please use the <a href="%s" title="Regenerate thumbnails" target="_blank">Regenerate thumbnails</a> plugin in order to update your images.', 'lawyers-attorneys'), 'http://wordpress.org/extend/plugins/regenerate-thumbnails/'),
	'type' => 'select-row',
	'selects' => array(
