...
array(
	'name' => __('Footer Layout', 'lawyers-attorneys'),
...
array(
	'name' => __('Enable Footer Widget Areas', 'lawyers-attorneys'),
	'desc' => __('This option only enables the area. You can set the layout, using the two options below.  In appearance - widgets, you can populate the area with widgets.', 'lawyers-attorneys'),
	'id' => 'has-footer-sidebars',
	'type' => 'toggle',
),

array(
	'name' => __('Footer Widget Area Pre-defined Layouts', 'lawyers-attorneys'),
	'desc' => __('The widget areas bellow are placed between the body and the sub-footer.  You can either choose one of the predefined layouts or configure your own in the "Advanced" section bellow.', 'lawyers-attorneys'),
	'type' => 'autofill',
	'class' => 'no-box',
	'option_sets' => array(
		array(
...
array(
	'name' => __('Footer Widget Areas Advanced Layout Builder', 'lawyers-attorneys'),
...
array(
	'name' => __('Text Area in Footer', 'lawyers-attorneys'),
	'desc' => __('You can place text/HTML or any shortcode in this field. The text will appear in the  footer of your website.', 'lawyers-attorneys'),
	'id' => 'credits',
	'type' => 'textarea',
	'static' => true,
),
