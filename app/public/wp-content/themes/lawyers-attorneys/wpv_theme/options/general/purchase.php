...
return array(
array(
	'name' => __('Purchase', 'lawyers-attorneys'),
	'type' => 'start'
),

array(
	'name' => __('Why do you need this information?', 'lawyers-attorneys'),
	'desc' => __('Filling these fields allows us to implement automatic updates for your Vamtam theme. Your theme will still be working if you leave these options empty, although you will have to install updates manually.<br>
		...
		Please note that any modifications made to the theme files will be overwritten after an automatic update, if you do not have a child theme enabled. Your theme options and content will be preserved.', 'lawyers-attorneys'),
	'type' => 'info',
),

array(
	'name' => __('Your Item Purchase Code', 'lawyers-attorneys') ,
	'desc' => __(' To obtain the Item Purchase Code login to your ThemeForest account that was used to purchase the theme with. Click on your "Downloads" section and then click on "License certificate and purchase code". This will prompt you to either open or save a text file containing your purchase license information. Look for Item Purchase Code', 'lawyers-attorneys'),
...
array(
	'name' => __( 'Validate Purchase Information', 'lawyers-attorneys' ),
	'desc' => __( 'Please be aware that without this information you can\'t use the automatic update feature. Updating using FTP is only for advanced users and you can’t update the bundled with the theme plugins using FTP method.', 'lawyers-attorneys' ),
	'title' => __( 'Check', 'lawyers-attorneys' ),
	'link' => '#',
	'type' => 'button',
	'data' => array(
...
<h5>Support</h5>
 If you have any questions that are beyond the scope of this help file, please feel free to <a href="%s">email us</a> or open a ticket in our <a href="%s">Help Desk</a>. You can <a href="%s">follow us on twitter</a> to get the updates. Thanks so much!', 'lawyers-attorneys'), 'http://themeforest.net/licenses', 'mailto:support@vamtam.com', 'http://support.vamtam.com', 'https://twitter.com/vamtam' ),
	),
	'button_class' => 'vamtam-check-license',
),

array(
	'name' => __('Disable System Status Information Gathering', 'lawyers-attorneys'),
