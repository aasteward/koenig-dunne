...
array(
	'name' => __('General Typography', 'lawyers-attorneys'),
	'type' => 'start',
),
...
array(
	'name' => __('Headlines', 'lawyers-attorneys'),
	'type' => 'separator',
),

array(
	'name' => __('H1', 'lawyers-attorneys'),
	'id' => 'h1',
	'type' => 'font',
	'min' => 14,
	'max' => 60,
...
array(
	'name' => __('Additional Font Styles', 'lawyers-attorneys'),
	'type' => 'separator',
),

array(
	'name' => __('Emphasis Font', 'lawyers-attorneys'),
	'id' => 'em',
	'type' => 'font',
	'min' => 1,
	'max' => 100,
...
array(
	'name' => __('Style 1', 'lawyers-attorneys'),
...
array(
	'name' => __('Style 2', 'lawyers-attorneys'),
...
array(
	'name' => __('Google Fonts Subsets', 'lawyers-attorneys'),
