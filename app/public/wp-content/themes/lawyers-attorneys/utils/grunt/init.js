	...
	return {
		...
		concat: {
			...
			dist: {
				src: [
					...
					'<%= pkg.jsLocation %>plugins/thirdparty/responsive-elements.js',
		...
		ucss: {
			local: {
				...
				pages: {
					crawl: 'http://lawyers-attorneys.demo.local',
					include: []
				},
				css: ['http://lawyers-attorneys.demo.local/wp-content/themes/lawyers-attorneys/cache/all.css']
			}
		}
	};
};